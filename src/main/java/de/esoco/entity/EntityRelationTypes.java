...
public class EntityRelationTypes
{
	 ...
	 *
	 * @see #newEntityAttribute(RelationTypeModifier...)
	 */
	public static RelationType<Entity> newArbitraryEntityAttribute(
	 ...
	 */
	public static RelationType<Integer> newAutoIdAttribute(
		RelationTypeModifier... rFlags)
	{
		return newIdAttribute(rFlags).annotate(AUTOGENERATED);
	}
	 ...
	 */
	public static <T extends Entity> RelationType<List<T>> newChildAttribute(
		RelationTypeModifier... rFlags)
	{
	 ...
	 *         RelationTypeModifier...)
	 */
	public static <T extends Entity> RelationType<T> newEntityAttribute(
		RelationTypeModifier... rFlags)
	{
	 ...
	 *      RelationTypeModifier...)
	 */
	public static RelationType<Long> newLongAutoIdAttribute(
		RelationTypeModifier... rFlags)
	{
		return newLongIdAttribute(rFlags).annotate(AUTOGENERATED);
	}
	 ...
	 *         RelationTypeModifier...)
	 */
	public static <T extends Entity> RelationType<T> newParentAttribute(
		RelationTypeModifier... rFlags)
	{
		return EntityRelationTypes.<T>newEntityAttribute(rFlags)
								  .annotate(PARENT_ATTRIBUTE);
	}

	/***************************************
	 * Creates a new relation type for the root entity in a hierarchy similar to
	 * {@link #newParentAttribute(RelationTypeModifier...)}.
	 *
	 * @see #newParentAttribute(RelationTypeModifier...)
	 */
	public static <T extends Entity> RelationType<T> newRootAttribute(
		RelationTypeModifier... rFlags)
	{
		return EntityRelationTypes.<T>newEntityAttribute(rFlags)
	...
	public static void setAttributeDisplayProperty(
		...
		RelationType<?>...    rAttributes)
	{
		setAttributeDisplayProperty(rProperty,
