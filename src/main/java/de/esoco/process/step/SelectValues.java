...
public class SelectValues<T extends Comparable<T>> extends InteractionFragment
{
	 ...
	 *
	 * @param sIdentifier      A process step-unique identifier of this instance
	 ...
	 */
	public SelectValues(String		  sIdentifier,
						Class<T>	  rValueDatatype,
						Collection<T> rAvailableValues,
						boolean		  bSortValues)
	{
	...
	public void init() throws Exception
	{
		...
		setInteractive(InteractiveInputMode.ACTION,
					   aUnselectedValuesParam,
					   aSelectedValuesParam);
	...
	/***************************************
	 * Initializes a parameter for this fragment. This sets a generic style name
	 * so that all fragments of this type can be styled similarly. This method
	 * should typically be invoked from the {@link InteractionFragment#init()
	 * init()} method of the parent fragment.
	 *
	...
	/***************************************
	 * Sorts a collection of values under consideration of the preferred values.
